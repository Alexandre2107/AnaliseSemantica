...
repeticao:
        T_ENQTO                                                 {printf("%d NADA\n", linha);}
        expressao
        T_FACA                                                  {linha++; printf("DSVF %d\n", linha);} 
        lista_comandos                                          {linha--; printf("DSVS %d\n", linha); linha++; printf("%d NADA\n", linha); linha++;}
        T_FIMENQTO
        ;

selecao:
        T_SE expressao                                          {printf("DSVF %d\n", linha); linha++;} 
        T_ENTAO lista_comandos                                  {printf("DSVS %d\n", linha++); linha--; linha--; printf("%d NADA\n", linha++);} 
        T_SENAO lista_comandos                                  {printf("%d NADA\n", linha++);} 
        T_FIMSE
        ;
